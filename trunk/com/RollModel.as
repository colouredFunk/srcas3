package com{
	...
	public class RollModel extends Sprite{
		...
		private function radianFloor(_radian:Number):Number {
			if (_radian>=Math.PI) {
				_radian-=2*Math.PI;
			}
			if (_radian<=- Math.PI) {
		...
		private function depthSort(_clip_0:*, _clip_1:*):int {    
