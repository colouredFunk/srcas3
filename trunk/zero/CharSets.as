...
package zero{
	public class CharSets{
		/*public static function getCodes():void{
			...
			trace("public static const charsetV:Vector.<String>=Vector.<String>(["+firstLabelArr+"]);");
		}
		*/
