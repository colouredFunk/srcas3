...
创建时间:2010年9月1日 18:47:24 (代码生成器: F:/airs/program files2/CodesGenerater/bin-debug/CodesGenerater.swf) 
历次修改:未有修改
用法举例:这家伙很懒什么都没写
*/
...
package zero.swf.tag_body{
	...
	public class DefineShape3 extends TagBody{
		...
		override public function initByData(data:ByteArray,offset:int,endOffset:int):int{
			...
			offset=Shapes.initByData(data,offset,endOffset);
			return offset;
		}
