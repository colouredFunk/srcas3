/***
Code_u30_Register 版本:v1.0
简要说明:这家伙很懒什么都没写
创建人:ZЁЯ¤  身高:168cm+;体重:57kg+;未婚(已有女友);最爱的运动:睡觉;格言:路见不平,拔腿就跑;QQ:358315553
创建时间:2010年7月12日 22:16:56
历次修改:未有修改
用法举例:这家伙很懒什么都没写
*/
...
package zero.swf.avm2.codes{
	...
	import flash.events.*;
	import flash.utils.*;
	public class Code_u30_Register extends Code_u30 implements ICodeObj,IClassObj{
		//
		public function Code_u30_Register(registerId:int){
			u30=registerId;
		}
		//
