...
package zero.swf.avm2{
	...
	public class Method_body_info extends AVM2Obj{
		...
		override public function initByData(data:ByteArray,offset:int,endOffset:int):int{
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							method=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							method=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						method=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					method=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
				method=data[offset++];
			}
			...
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							max_stack=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							max_stack=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						max_stack=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					max_stack=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
			...
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							local_count=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							local_count=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						local_count=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					local_count=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
			...
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							init_scope_depth=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							init_scope_depth=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						init_scope_depth=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					init_scope_depth=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
			...
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							max_scope_depth=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							max_scope_depth=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						max_scope_depth=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					max_scope_depth=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
			...
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							codes_length=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							codes_length=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						codes_length=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					codes_length=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
			...
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							var exception_info_count:int=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							exception_info_count=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						exception_info_count=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					exception_info_count=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
				exception_info_count=data[offset++];
			}
			//
		...
		override public function toData():ByteArray{
			...
			if(method>>>7){
				if(method>>>14){
					if(method>>>21){
						if(method>>>28){
							data[offset++]=(method&0x7f)|0x80;
							data[offset++]=((method>>>7)&0x7f)|0x80;
							data[offset++]=((method>>>14)&0x7f)|0x80;
							data[offset++]=((method>>>21)&0x7f)|0x80;
							data[offset++]=method>>>28;
						}else{
							data[offset++]=(method&0x7f)|0x80;
							data[offset++]=((method>>>7)&0x7f)|0x80;
							data[offset++]=((method>>>14)&0x7f)|0x80;
							data[offset++]=method>>>21;
						}
					}else{
						data[offset++]=(method&0x7f)|0x80;
						data[offset++]=((method>>>7)&0x7f)|0x80;
						data[offset++]=method>>>14;
					}
				}else{
					data[offset++]=(method&0x7f)|0x80;
					data[offset++]=method>>>7;
				}
			}else{
				data[offset++]=method;
			}
			...
			if(max_stack>>>7){
				if(max_stack>>>14){
					if(max_stack>>>21){
						if(max_stack>>>28){
							data[offset++]=(max_stack&0x7f)|0x80;
							data[offset++]=((max_stack>>>7)&0x7f)|0x80;
							data[offset++]=((max_stack>>>14)&0x7f)|0x80;
							data[offset++]=((max_stack>>>21)&0x7f)|0x80;
							data[offset++]=max_stack>>>28;
						}else{
							data[offset++]=(max_stack&0x7f)|0x80;
							data[offset++]=((max_stack>>>7)&0x7f)|0x80;
							data[offset++]=((max_stack>>>14)&0x7f)|0x80;
							data[offset++]=max_stack>>>21;
						}
					}else{
						data[offset++]=(max_stack&0x7f)|0x80;
						data[offset++]=((max_stack>>>7)&0x7f)|0x80;
						data[offset++]=max_stack>>>14;
					}
				}else{
					data[offset++]=(max_stack&0x7f)|0x80;
					data[offset++]=max_stack>>>7;
				}
			}else{
			...
			if(local_count>>>7){
				if(local_count>>>14){
					if(local_count>>>21){
						if(local_count>>>28){
							data[offset++]=(local_count&0x7f)|0x80;
							data[offset++]=((local_count>>>7)&0x7f)|0x80;
							data[offset++]=((local_count>>>14)&0x7f)|0x80;
							data[offset++]=((local_count>>>21)&0x7f)|0x80;
							data[offset++]=local_count>>>28;
						}else{
							data[offset++]=(local_count&0x7f)|0x80;
							data[offset++]=((local_count>>>7)&0x7f)|0x80;
							data[offset++]=((local_count>>>14)&0x7f)|0x80;
							data[offset++]=local_count>>>21;
						}
					}else{
						data[offset++]=(local_count&0x7f)|0x80;
						data[offset++]=((local_count>>>7)&0x7f)|0x80;
						data[offset++]=local_count>>>14;
					}
				}else{
					data[offset++]=(local_count&0x7f)|0x80;
					data[offset++]=local_count>>>7;
				}
			}else{
			...
			if(init_scope_depth>>>7){
				if(init_scope_depth>>>14){
					if(init_scope_depth>>>21){
						if(init_scope_depth>>>28){
							data[offset++]=(init_scope_depth&0x7f)|0x80;
							data[offset++]=((init_scope_depth>>>7)&0x7f)|0x80;
							data[offset++]=((init_scope_depth>>>14)&0x7f)|0x80;
							data[offset++]=((init_scope_depth>>>21)&0x7f)|0x80;
							data[offset++]=init_scope_depth>>>28;
						}else{
							data[offset++]=(init_scope_depth&0x7f)|0x80;
							data[offset++]=((init_scope_depth>>>7)&0x7f)|0x80;
							data[offset++]=((init_scope_depth>>>14)&0x7f)|0x80;
							data[offset++]=init_scope_depth>>>21;
						}
					}else{
						data[offset++]=(init_scope_depth&0x7f)|0x80;
						data[offset++]=((init_scope_depth>>>7)&0x7f)|0x80;
						data[offset++]=init_scope_depth>>>14;
					}
				}else{
					data[offset++]=(init_scope_depth&0x7f)|0x80;
					data[offset++]=init_scope_depth>>>7;
				}
			}else{
			...
			if(max_scope_depth>>>7){
				if(max_scope_depth>>>14){
					if(max_scope_depth>>>21){
						if(max_scope_depth>>>28){
							data[offset++]=(max_scope_depth&0x7f)|0x80;
							data[offset++]=((max_scope_depth>>>7)&0x7f)|0x80;
							data[offset++]=((max_scope_depth>>>14)&0x7f)|0x80;
							data[offset++]=((max_scope_depth>>>21)&0x7f)|0x80;
							data[offset++]=max_scope_depth>>>28;
						}else{
							data[offset++]=(max_scope_depth&0x7f)|0x80;
							data[offset++]=((max_scope_depth>>>7)&0x7f)|0x80;
							data[offset++]=((max_scope_depth>>>14)&0x7f)|0x80;
							data[offset++]=max_scope_depth>>>21;
						}
					}else{
						data[offset++]=(max_scope_depth&0x7f)|0x80;
						data[offset++]=((max_scope_depth>>>7)&0x7f)|0x80;
						data[offset++]=max_scope_depth>>>14;
					}
				}else{
					data[offset++]=(max_scope_depth&0x7f)|0x80;
					data[offset++]=max_scope_depth>>>7;
				}
			}else{
			...
			if(codes_length>>>7){
				if(codes_length>>>14){
					if(codes_length>>>21){
						if(codes_length>>>28){
							data[offset++]=(codes_length&0x7f)|0x80;
							data[offset++]=((codes_length>>>7)&0x7f)|0x80;
							data[offset++]=((codes_length>>>14)&0x7f)|0x80;
							data[offset++]=((codes_length>>>21)&0x7f)|0x80;
							data[offset++]=codes_length>>>28;
						}else{
							data[offset++]=(codes_length&0x7f)|0x80;
							data[offset++]=((codes_length>>>7)&0x7f)|0x80;
							data[offset++]=((codes_length>>>14)&0x7f)|0x80;
							data[offset++]=codes_length>>>21;
						}
					}else{
						data[offset++]=(codes_length&0x7f)|0x80;
						data[offset++]=((codes_length>>>7)&0x7f)|0x80;
						data[offset++]=codes_length>>>14;
					}
				}else{
					data[offset++]=(codes_length&0x7f)|0x80;
					data[offset++]=codes_length>>>7;
				}
			}else{
				data[offset++]=codes_length;
			}
			//
			...
			if(exception_info_count>>>7){
				if(exception_info_count>>>14){
					if(exception_info_count>>>21){
						if(exception_info_count>>>28){
							data[offset++]=(exception_info_count&0x7f)|0x80;
							data[offset++]=((exception_info_count>>>7)&0x7f)|0x80;
							data[offset++]=((exception_info_count>>>14)&0x7f)|0x80;
							data[offset++]=((exception_info_count>>>21)&0x7f)|0x80;
							data[offset++]=exception_info_count>>>28;
						}else{
							data[offset++]=(exception_info_count&0x7f)|0x80;
							data[offset++]=((exception_info_count>>>7)&0x7f)|0x80;
							data[offset++]=((exception_info_count>>>14)&0x7f)|0x80;
							data[offset++]=exception_info_count>>>21;
						}
					}else{
						data[offset++]=(exception_info_count&0x7f)|0x80;
						data[offset++]=((exception_info_count>>>7)&0x7f)|0x80;
						data[offset++]=exception_info_count>>>14;
					}
				}else{
					data[offset++]=(exception_info_count&0x7f)|0x80;
					data[offset++]=exception_info_count>>>7;
				}
			}else{
			...
			for each(var exception_info:Exception_info in exception_infoV){
				data.writeBytes(exception_info.toData());
			}
			offset=data.length;
