...
package zero.swf.avm2{
	...
	public class Namespace_info{//implements I_zero_swf_CheckCodesRight{
		...
		CONFIG::USE_XML{
			public function toXML(xmlName:String,_toXMLOptions:Object/*zero_swf_ToXMLOptions*/):XML{
				return <{xmlName} class="zero.swf.avm2.Namespace_info"
					kind={NamespaceKinds.kindV[kind]}
					name={name}
					info={name>0?_toXMLOptions.stringV[name]:"(undefined)"}
				/>;
			}
			public function toInfo(_toXMLOptions:Object):String{
				return "["+NamespaceKinds.kindV[kind]+"]"+(name>0?_toXMLOptions.stringV[name]:"(undefined)");
			}
