...
package zero.swf.avm2{
	...
	public class AVM2Ops{
		...
		public static const opNameV:Vector.<String>=new <String>[
			null,//0x00
			"bkpt",//0x01
			"nop",//0x02
			"throw_",//0x03
		...
		public static const opTypeV:Vector.<String>=new <String>[
			null,//0x0 null
			"op",//0x1 bkpt
			"op",//0x2 nop
			"op",//0x3 throw_
			"multiname",//0x4 getsuper
			"multiname",//0x5 setsuper
			"string",//0x6 dxns
			"op",//0x7 dxnslate
			"int",//0x8 kill
			"op",//0x9 label
			...
			"branch",//0x17 ifgt
			"branch",//0x18 ifge
			"branch",//0x19 ifstricteq
			"branch",//0x1a ifstrictne
			"lookupswitch",//0x1b lookupswitch
			"op",//0x1c pushwith
			"op",//0x1d popscope
			"op",//0x1e nextname
			"op",//0x1f hasnext
			"op",//0x20 pushnull
			"op",//0x21 pushundefined
			null,//0x22 null
			"op",//0x23 nextvalue
			"pushbyte",//0x24 pushbyte
			"int",//0x25 pushshort
			"op",//0x26 pushtrue
			"op",//0x27 pushfalse
			"op",//0x28 pushnan
			...
			"op",//0x2a dup
			"op",//0x2b swap
			"string",//0x2c pushstring
			"pushint",//0x2d pushint
			"pushuint",//0x2e pushuint
			"pushdouble",//0x2f pushdouble
			"op",//0x30 pushscope
			"pushnamespace",//0x31 pushnamespace
			"hasnext2",//0x32 hasnext2
			null,//0x33 null
			null,//0x34 null
			"op",//0x35 li8
			"op",//0x36 li16
			...
			"op",//0x3e sf64
			null,//0x3f null
			"newfunction",//0x40 newfunction
			"int",//0x41 call
			"int",//0x42 construct
			"method args",//0x43 callmethod
			"method args",//0x44 callstatic
			"multiname args",//0x45 callsuper
			"multiname args",//0x46 callproperty
			"op",//0x47 returnvoid
			"op",//0x48 returnvalue
			"int",//0x49 constructsuper
			"multiname args",//0x4a constructprop
			null,//0x4b null
			"multiname args",//0x4c callproplex
			null,//0x4d null
			"multiname args",//0x4e callsupervoid
			"multiname args",//0x4f callpropvoid
			"op",//0x50 sxi1
			"op",//0x51 sxi8
			"op",//0x52 sxi16
			"int",//0x53 applytype
			...
			"int",//0x55 newobject
			"int",//0x56 newarray
			"op",//0x57 newactivation
			"newclass",//0x58 newclass
			"multiname",//0x59 getdescendants
			"newcatch",//0x5a newcatch
			null,//0x5b null
			null,//0x5c null
			"multiname",//0x5d findpropstrict
			"multiname",//0x5e findproperty
			"finddef",//0x5f finddef
			"multiname",//0x60 getlex
			"multiname",//0x61 setproperty
			"int",//0x62 getlocal
			"int",//0x63 setlocal
			"op",//0x64 getglobalscope
			"int",//0x65 getscopeobject
			"multiname",//0x66 getproperty
			null,//0x67 null
			"multiname",//0x68 initproperty
			null,//0x69 null
			"multiname",//0x6a deleteproperty
			null,//0x6b null
			"int",//0x6c getslot
			"int",//0x6d setslot
			"int",//0x6e getglobalslot
			"int",//0x6f setglobalslot
			"op",//0x70 convert_s
			"op",//0x71 esc_xelem
			"op",//0x72 esc_xattr
			"op",//0x73 convert_i
			...
			null,//0x7e null
			null,//0x7f null
			"multiname",//0x80 coerce
			"op",//0x81 coerce_b
			"op",//0x82 coerce_a
			"op",//0x83 coerce_i
			"op",//0x84 coerce_d
			"op",//0x85 coerce_s
			"multiname",//0x86 astype
			"op",//0x87 astypelate
			"op",//0x88 coerce_u
			"op",//0x89 coerce_o
			null,//0x8a null
			...
			"op",//0xaa bitxor
			"op",//0xab equals
			"op",//0xac strictequals
			"op",//0xad lessthan
			"op",//0xae lessequals
			"op",//0xaf greaterthan
			"op",//0xb0 greaterequals
			"op",//0xb1 instanceof_
			"multiname",//0xb2 istype
			"op",//0xb3 istypelate
			"op",//0xb4 in_
			null,//0xb5 null
			null,//0xb6 null
