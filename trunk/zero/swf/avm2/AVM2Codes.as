...
package zero.swf.avm2{
	...
	public class AVM2Codes{
		...
		internal var hexArr:Array;//只用于 toXML 20110528
		...
		public function initByInfo(
			...
			var numArrArr:Array=new Array();
			var fixedJumpPosArr:Array=new Array();
			var errorCodeArr:Array=new Array();
			
			var u30_1:int,u30_2:int,jumpOffset:int,jumpPos:int,i:int,numArr:Array;
			...
			while(offset<endOffset){
				...
				switch(AVM2Ops.opTypeV[op]){
					...
					case "pushint":
						...
						//u30_1
						if(u30_1>0&&u30_1<integerV.length){
							...
							codeByPosArr[pos]=numArr;
							numArrArr.push(numArr);
						}
					break;
					...
					case "pushuint":
						if(data[offset]>>>7){if(data[offset+1]>>>7){if(data[offset+2]>>>7){if(data[offset+3]>>>7){u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);}}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);}}else{u30_1=(data[offset++]&0x7f)|(data[offset++]<<7);}}else{u30_1=data[offset++];}
						//u30_1
						if(u30_1>0&&u30_1<uintegerV.length){
					...
					case "pushdouble":
						if(data[offset]>>>7){if(data[offset+1]>>>7){if(data[offset+2]>>>7){if(data[offset+3]>>>7){u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);}}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);}}else{u30_1=(data[offset++]&0x7f)|(data[offset++]<<7);}}else{u30_1=data[offset++];}
						//u30_1
						if(u30_1>0&&u30_1<doubleV.length){
					...
					case "string":
						if(data[offset]>>>7){if(data[offset+1]>>>7){if(data[offset+2]>>>7){if(data[offset+3]>>>7){u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);}}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);}}else{u30_1=(data[offset++]&0x7f)|(data[offset++]<<7);}}else{u30_1=data[offset++];}
						//u30_1
						if(u30_1>0&&u30_1<stringV.length){
					...
					case "pushnamespace":
						if(data[offset]>>>7){if(data[offset+1]>>>7){if(data[offset+2]>>>7){if(data[offset+3]>>>7){u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);}}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);}}else{u30_1=(data[offset++]&0x7f)|(data[offset++]<<7);}}else{u30_1=data[offset++];}
						//u30_1
						if(u30_1>0&&u30_1<allNsV.length){
					...
					case "multiname":
						if(data[offset]>>>7){if(data[offset+1]>>>7){if(data[offset+2]>>>7){if(data[offset+3]>>>7){u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);}}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);}}else{u30_1=(data[offset++]&0x7f)|(data[offset++]<<7);}}else{u30_1=data[offset++];}
						//u30_1
						if(u30_1>0&&u30_1<allMultinameV.length){
					...
					case "newfunction":
						if(data[offset]>>>7){if(data[offset+1]>>>7){if(data[offset+2]>>>7){if(data[offset+3]>>>7){u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);}}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);}}else{u30_1=(data[offset++]&0x7f)|(data[offset++]<<7);}}else{u30_1=data[offset++];}
						//u30_1
						if(u30_1>-1&&u30_1<allMethodV.length){
					...
					case "newclass":
						if(data[offset]>>>7){if(data[offset+1]>>>7){if(data[offset+2]>>>7){if(data[offset+3]>>>7){u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);}}else{u30_1=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);}}else{u30_1=(data[offset++]&0x7f)|(data[offset++]<<7);}}else{u30_1=data[offset++];}
						//u30_1
						if(u30_1>-1&&u30_1<classV.length){
					...
					case "finddef":
						...
						codeByPosArr[pos]=numArr;
						errorCodeArr.push(numArr);
						//outputError("恭喜你，你发现了一个 "+AVM2Ops.opNameV[op]+" 的例子！");
					break;
					...
					case "branch":
						...
						if(jumpPos<0||jumpPos>endOffset){
							fixedJumpPosArr.push([jumpPos,endOffset]);
							jumpPos=endOffset;
						}
					...
					case "lookupswitch":
						...
						case_count++;
						if(offset+case_count*3>endOffset){//20110927
							outputError("出错的 case_count："+case_count);
							case_count=(endOffset-offset)/3;
							outputError("修复为："+case_count);
						}
					...
					case "debug":
						...
						if(u30_1>0&&u30_1<stringV.length){
							...
							outputError("超出范围的 debug index："+u30_1);
							index="";
						}
			...
			if(offset==endOffset){
				...
				outputError("offset="+offset+",endOffset="+endOffset);
			}
			...
			for(offset=0;offset<=endOffset;offset++){
				...
				if(codeByPosArr[offset]==null){
					...
					if(hexArr){
						switch(codeArr[codeId].constructor){
							case LabelMark:
							break;
							case Array:
							case ByteArray:
			...
			if(numArrArr.length){
				outputError("用 numArr 记录的 "+numArrArr.length+" 条");//"用 numArr 记录的 "+AVM2Ops.opNameV[op]+"："+numArr
			}
			if(fixedJumpPosArr.length){
				outputError("修正 jumpPos "+fixedJumpPosArr.length+" 条");//"jumpPos 已修正为: "+jumpPos
			}
			if(errorCodeArr.length){
				outputError("恭喜你，你发现了 "+errorCodeArr.length+" 个 finddef，callmethod 或 callstatic 的例子！");
			}
		}
		...
		public function getInfo(productMark:ProductMark,_toDataOptions:Object):Array{
			...
			for each(var code:* in codeArr){
				switch(code.constructor){
					case LabelMark:
						code.pos=data.length;
					break;
					case Array:
						//output("使用 numArr 进行记录的未知代码："+code,"brown");
						for each(var num:int in code){
							data[data.length]=num;
						}
					break;
					case ByteArray:
						//output("使用 ByteArray 进行记录的未知代码："+BytesAndStr16.bytes2str16(code,0,code.length),"brown");
						data.position=data.length;
						data.writeBytes(code,0,code.length);
					break;
					case Code:
						data[data.length]=code.op;
						switch(AVM2Ops.opTypeV[code.op]){
							//case 0x24://AVM2Ops.pushbyte	//u8_u8
							case "pushbyte":
								data[data.length]=code.value;
							break;
							//case 0x25://AVM2Ops.pushshort	//u8_u30__value_int
							//case 0xf0://AVM2Ops.debugline	//u8_u30__value_int
							//case 0xf2://AVM2Ops.bkptline	//u8_u30__value_int
							...
							case "int":
								u30_1=code.value;
								if(u30_1>>>7){if(u30_1>>>14){if(u30_1>>>21){if(u30_1>>>28){data[data.length]=(u30_1&0x7f)|0x80;data[data.length]=((u30_1>>>7)&0x7f)|0x80;data[data.length]=((u30_1>>>14)&0x7f)|0x80;data[data.length]=((u30_1>>>21)&0x7f)|0x80;data[data.length]=u30_1>>>28;}else{data[data.length]=(u30_1&0x7f)|0x80;data[data.length]=((u30_1>>>7)&0x7f)|0x80;data[data.length]=((u30_1>>>14)&0x7f)|0x80;data[data.length]=u30_1>>>21;}}else{data[data.length]=(u30_1&0x7f)|0x80;data[data.length]=((u30_1>>>7)&0x7f)|0x80;data[data.length]=u30_1>>>14;}}else{data[data.length]=(u30_1&0x7f)|0x80;data[data.length]=u30_1>>>7;}}else{data[data.length]=u30_1;}
								//u30_1
							break;
							//case 0x2d://AVM2Ops.pushint	//u8_u30__int
							case "pushint":
							...
							case "hasnext2":
								...
								if(u30_2>>>7){if(u30_2>>>14){if(u30_2>>>21){if(u30_2>>>28){data[data.length]=(u30_2&0x7f)|0x80;data[data.length]=((u30_2>>>7)&0x7f)|0x80;data[data.length]=((u30_2>>>14)&0x7f)|0x80;data[data.length]=((u30_2>>>21)&0x7f)|0x80;data[data.length]=u30_2>>>28;}else{data[data.length]=(u30_2&0x7f)|0x80;data[data.length]=((u30_2>>>7)&0x7f)|0x80;data[data.length]=((u30_2>>>14)&0x7f)|0x80;data[data.length]=u30_2>>>21;}}else{data[data.length]=(u30_2&0x7f)|0x80;data[data.length]=((u30_2>>>7)&0x7f)|0x80;data[data.length]=u30_2>>>14;}}else{data[data.length]=(u30_2&0x7f)|0x80;data[data.length]=u30_2>>>7;}}else{data[data.length]=u30_2;}
								//u30_2
							break;
							//case 0x45://AVM2Ops.callsuper	//u8_u30_u30__multiname_info_args
							//case 0x46://AVM2Ops.callproperty	//u8_u30_u30__multiname_info_args
							...
							case "branch":
								...
								data[data.length]=0x00;
								data[data.length]=0x00;
								posMarkArr[data.length]=code.value;
							break;
							//case 0x1b://AVM2Ops.lookupswitch	//u8_s24_u30_s24List__lookupswitch
							case "lookupswitch":
								//The base location is the address of the lookupswitch instruction itself.
								posMarkArr[data.length-1]=code;
								
								code.value.default_offset_startPos=data.length;//- -
								...
								if(case_count>>>7){if(case_count>>>14){if(case_count>>>21){if(case_count>>>28){data[data.length]=(case_count&0x7f)|0x80;data[data.length]=((case_count>>>7)&0x7f)|0x80;data[data.length]=((case_count>>>14)&0x7f)|0x80;data[data.length]=((case_count>>>21)&0x7f)|0x80;data[data.length]=case_count>>>28;}else{data[data.length]=(case_count&0x7f)|0x80;data[data.length]=((case_count>>>7)&0x7f)|0x80;data[data.length]=((case_count>>>14)&0x7f)|0x80;data[data.length]=case_count>>>21;}}else{data[data.length]=(case_count&0x7f)|0x80;data[data.length]=((case_count>>>7)&0x7f)|0x80;data[data.length]=case_count>>>14;}}else{data[data.length]=(case_count&0x7f)|0x80;data[data.length]=case_count>>>7;}}else{data[data.length]=case_count;}
								//case_count
								
								code.value.case_offset_startPos=data.length;//- -
								data.length+=3*(case_count+1);
							break;
							//case 0xef://AVM2Ops.debug	//u8_u8_u30_u8_u30__debug
							case "debug":
								data[data.length]=code.value.debug_type;
								
								var debug_index:int=productMark.getStringId(code.value.index);
								
								if(debug_index>>>7){if(debug_index>>>14){if(debug_index>>>21){if(debug_index>>>28){data[data.length]=(debug_index&0x7f)|0x80;data[data.length]=((debug_index>>>7)&0x7f)|0x80;data[data.length]=((debug_index>>>14)&0x7f)|0x80;data[data.length]=((debug_index>>>21)&0x7f)|0x80;data[data.length]=debug_index>>>28;}else{data[data.length]=(debug_index&0x7f)|0x80;data[data.length]=((debug_index>>>7)&0x7f)|0x80;data[data.length]=((debug_index>>>14)&0x7f)|0x80;data[data.length]=debug_index>>>21;}}else{data[data.length]=(debug_index&0x7f)|0x80;data[data.length]=((debug_index>>>7)&0x7f)|0x80;data[data.length]=debug_index>>>14;}}else{data[data.length]=(debug_index&0x7f)|0x80;data[data.length]=debug_index>>>7;}}else{data[data.length]=debug_index;}
								//debug_index
								
								data[data.length]=code.value.reg;
								
								if(code.value.extra>>>7){if(code.value.extra>>>14){if(code.value.extra>>>21){if(code.value.extra>>>28){data[data.length]=(code.value.extra&0x7f)|0x80;data[data.length]=((code.value.extra>>>7)&0x7f)|0x80;data[data.length]=((code.value.extra>>>14)&0x7f)|0x80;data[data.length]=((code.value.extra>>>21)&0x7f)|0x80;data[data.length]=code.value.extra>>>28;}else{data[data.length]=(code.value.extra&0x7f)|0x80;data[data.length]=((code.value.extra>>>7)&0x7f)|0x80;data[data.length]=((code.value.extra>>>14)&0x7f)|0x80;data[data.length]=code.value.extra>>>21;}}else{data[data.length]=(code.value.extra&0x7f)|0x80;data[data.length]=((code.value.extra>>>7)&0x7f)|0x80;data[data.length]=code.value.extra>>>14;}}else{data[data.length]=(code.value.extra&0x7f)|0x80;data[data.length]=code.value.extra>>>7;}}else{data[data.length]=code.value.extra;}
								//code.value.extra
							break;
							default:
			...
			for(var offset:int=0;offset<=endOffset;offset++){
		...
		CONFIG::USE_XML{
			public function toXMLAndMark(markStrs:MarkStrs,xmlName:String,_toXMLOptions:Object):XML{
				...
				if(codeArr.length){
					...
					for each(var code:* in codeArr){
						...
						switch(code.constructor){
							...
							break;
							case ByteArray:
								codesStr+="\t\t\t\t\t//使用 ByteArray 进行记录的未知代码：\n";
							...
							case Code:
								switch(AVM2Ops.opTypeV[code.op]){
									...
									case "newfunction":
										...
										if(methodMarkStr){
											outputError("重复使用的 method");
											outputError("如引用的是 iinit 或 cinit 或 init 或 trait 里的 method 将可能不正常");
											codesStr+="\t\t\t\t\t//重复使用的 method：\n";//20110913
										}else{
											var methodXML:XML=method.toXMLAndMark(markStrs,"","method",_toXMLOptions);
											methodMarkStr=markStrs.markStrDict[method];
			...
			public function initByXMLAndMark(markStrs:MarkStrs,xml:XML,_initByXMLOptions:Object):void{
