		...
		override public function initByData(data:ByteArray,offset:int,endOffset:int):int{
			...
			if(data[offset]>>>7){
				if(data[offset+1]>>>7){
					if(data[offset+2]>>>7){
						if(data[offset+3]>>>7){
							classi=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|((data[offset++]&0x7f)<<21)|(data[offset++]<<28);
						}else{
							classi=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|((data[offset++]&0x7f)<<14)|(data[offset++]<<21);
						}
					}else{
						classi=(data[offset++]&0x7f)|((data[offset++]&0x7f)<<7)|(data[offset++]<<14);
					}
				}else{
					classi=(data[offset++]&0x7f)|(data[offset++]<<7);
				}
			}else{
				classi=data[offset++];
			}
		...
		override public function toData():ByteArray{
			...
			if(classi>>>7){
				if(classi>>>14){
					if(classi>>>21){
						if(classi>>>28){
							data[offset++]=(classi&0x7f)|0x80;
							data[offset++]=((classi>>>7)&0x7f)|0x80;
							data[offset++]=((classi>>>14)&0x7f)|0x80;
							data[offset++]=((classi>>>21)&0x7f)|0x80;
							data[offset++]=classi>>>28;
						}else{
							data[offset++]=(classi&0x7f)|0x80;
							data[offset++]=((classi>>>7)&0x7f)|0x80;
							data[offset++]=((classi>>>14)&0x7f)|0x80;
							data[offset++]=classi>>>21;
						}
					}else{
						data[offset++]=(classi&0x7f)|0x80;
						data[offset++]=((classi>>>7)&0x7f)|0x80;
						data[offset++]=classi>>>14;
					}
				}else{
					data[offset++]=(classi&0x7f)|0x80;
					data[offset++]=classi>>>7;
				}
			}else{
				data[offset++]=classi;
			}
