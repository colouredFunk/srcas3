...
package zero.swf{
	...
	public class SWFProgresser{
		...
		//仅用于 initByData
		private var initByDataOptions:Object;
		
		//仅用于 toData
		private var toDataOptions:Object;
		private var tagsData:ByteArray;
		
		CONFIG::USE_XML{
			//仅用于 toXML
			private var toXMLOptions:Object;
			private var tagsXML:XML;
			private var frameIdDict:Dictionary;
			
			//仅用于 initByXML
			private var initByXMLOptions:Object;
		...
		public function toSWFData(_swf:SWF,_toDataOptions:Object,_onProgress:Function,_onComplete:Function):void{
			clear();
		...
		private function toSWFData_end():ByteArray{
			return swf.toSWFData_end(tagsData,null);
		}
		
		CONFIG::USE_XML{
			public function toXML(_swf:SWF,_toXMLOptions:Object,_onProgress:Function,_onComplete:Function):void{
				clear();
			...
			public function initByXML(_swf:SWF,xml:XML,_initByXMLOptions:Object,_onProgress:Function,_onComplete:Function):void{
				clear();
