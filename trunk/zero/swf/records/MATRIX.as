...
package zero.swf.records{
	...
	public class MATRIX{//implements I_zero_swf_CheckCodesRight{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			HasScale=Boolean(bGroupValue&0x80000000);						//10000000 00000000 00000000 00000000
			...
			HasRotate=Boolean((bGroupValue<<bGroupBitsOffset)>>>31);
			++bGroupBitsOffset;
		...
		public function toXML(xmlName:String,_toXMLOptions:Object/*zero_swf_ToXMLOptions*/):XML{
			var xml:XML=<{xmlName} class="zero.swf.records.MATRIX"/>;
			if(HasScale){
