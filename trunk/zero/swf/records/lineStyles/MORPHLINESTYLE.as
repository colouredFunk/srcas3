...
package zero.swf.records.lineStyles{
	...
	public class MORPHLINESTYLE extends BaseLineStyle{
		...
		override public function initByData(data:ByteArray,offset:int,endOffset:int):int{
			...
			StartColor=(data[offset+4]<<16)|(data[offset+5]<<8)|data[offset+6]|(data[offset+7]<<24);
			EndColor=(data[offset+8]<<16)|(data[offset+9]<<8)|data[offset+10]|(data[offset+11]<<24);
			return offset+12;
		}
		...
		override public function toXML(xmlName:String):XML{
			return <{xmlName} class="MORPHLINESTYLE"
