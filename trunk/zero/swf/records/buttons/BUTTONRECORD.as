...
package zero.swf.records.buttons{
	...
	public class BUTTONRECORD{//implements I_zero_swf_CheckCodesRight{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			ButtonStateHitTest=Boolean(flags&0x08);			//00001000
			ButtonStateDown=Boolean(flags&0x04);			//00000100
			ButtonStateOver=Boolean(flags&0x02);			//00000010
			ButtonStateUp=Boolean(flags&0x01);				//00000001
