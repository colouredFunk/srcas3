...
package zero.swf.tagBodys{
	...
	public class DefineMorphShape{//implements I_zero_swf_CheckCodesRight{
		...
		public var StartBounds:*;
		public var EndBounds:*;
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			offset+=2;
			StartBounds=new (_initByDataOptions&&_initByDataOptions.classes&&_initByDataOptions.classes["zero.swf.records.RECT"]||RECT)();
			offset=StartBounds.initByData(data,offset,endOffset,_initByDataOptions);
			
			EndBounds=new (_initByDataOptions&&_initByDataOptions.classes&&_initByDataOptions.classes["zero.swf.records.RECT"]||RECT)();
		...
		public function initByXML(xml:XML,_initByXMLOptions:Object/*zero_swf_InitByXMLOptions*/):void{
			...
			StartBounds=new (_initByXMLOptions&&_initByXMLOptions.customClasses&&_initByXMLOptions.customClasses[xml.StartBounds[0]["@class"].toString()]||RECT)();
			StartBounds.initByXML(xml.StartBounds[0],_initByXMLOptions);
			EndBounds=new (_initByXMLOptions&&_initByXMLOptions.customClasses&&_initByXMLOptions.customClasses[xml.EndBounds[0]["@class"].toString()]||RECT)();
