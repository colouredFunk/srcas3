...
创建时间：2011年08月17日 19:45:29（代码生成器 V2.0.0 F:/airs/program files2/CodesGenerater2/bin-debug/CodesGenerater2.swf）
简要说明：这家伙很懒什么都没写。
用法举例：这家伙还是很懒什么都没写。
*/
	...
	public class EnableDebugger{
		...
		CONFIG::USE_XML{
			public function toXML(xmlName:String,_toXMLOptions:Object):XML{
				...
				return <{xmlName} class="zero.swf.tagBodys.EnableDebugger"
					password={password}
				/>
