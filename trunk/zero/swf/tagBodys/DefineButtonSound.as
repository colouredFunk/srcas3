...
package zero.swf.tagBodys{
	...
	public class DefineButtonSound{//implements I_zero_swf_CheckCodesRight{
		...
		public var ButtonSoundInfo0:*;
		public var ButtonSoundChar1:int;				//UI16
		public var ButtonSoundInfo1:*;
		public var ButtonSoundChar2:int;				//UI16
		public var ButtonSoundInfo2:*;
		public var ButtonSoundChar3:int;				//UI16
		public var ButtonSoundInfo3:*;
		//
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			ButtonId=data[offset++]|(data[offset++]<<8);
			
			var ButtonSoundInfoClass:Class;
			if(_initByDataOptions){
				if(_initByDataOptions.classes){
					ButtonSoundInfoClass=_initByDataOptions.classes["zero.swf.records.sounds.SOUNDINFO"];
				}
			}
			if(ButtonSoundInfoClass){
			}else{
				ButtonSoundInfoClass=SOUNDINFO;
			}
			
			ButtonSoundChar0=data[offset++]|(data[offset++]<<8);
			if(ButtonSoundChar0){
			
				ButtonSoundInfo0=new ButtonSoundInfoClass();
			...
			if(ButtonSoundChar1){
				...
				ButtonSoundInfo1=new ButtonSoundInfoClass();
			...
			if(ButtonSoundChar2){
				...
				ButtonSoundInfo2=new ButtonSoundInfoClass();
			...
			if(ButtonSoundChar3){
				...
				ButtonSoundInfo3=new ButtonSoundInfoClass();
		...
		public function initByXML(xml:XML,_initByXMLOptions:Object/*zero_swf_InitByXMLOptions*/):void{
			...
			if(ButtonSoundChar0){
				ButtonSoundInfo0=new (_initByXMLOptions&&_initByXMLOptions.customClasses&&_initByXMLOptions.customClasses[xml.ButtonSoundInfo0[0]["@class"].toString()]||SOUNDINFO)();
				ButtonSoundInfo0.initByXML(xml.ButtonSoundInfo0[0],_initByXMLOptions);
			}
			ButtonSoundChar1=int(xml.@ButtonSoundChar1.toString());
			if(ButtonSoundChar1){
				ButtonSoundInfo1=new (_initByXMLOptions&&_initByXMLOptions.customClasses&&_initByXMLOptions.customClasses[xml.ButtonSoundInfo1[0]["@class"].toString()]||SOUNDINFO)();
				ButtonSoundInfo1.initByXML(xml.ButtonSoundInfo1[0],_initByXMLOptions);
			}
			ButtonSoundChar2=int(xml.@ButtonSoundChar2.toString());
			if(ButtonSoundChar2){
				ButtonSoundInfo2=new (_initByXMLOptions&&_initByXMLOptions.customClasses&&_initByXMLOptions.customClasses[xml.ButtonSoundInfo2[0]["@class"].toString()]||SOUNDINFO)();
				ButtonSoundInfo2.initByXML(xml.ButtonSoundInfo2[0],_initByXMLOptions);
			}
			ButtonSoundChar3=int(xml.@ButtonSoundChar3.toString());
			if(ButtonSoundChar3){
				ButtonSoundInfo3=new (_initByXMLOptions&&_initByXMLOptions.customClasses&&_initByXMLOptions.customClasses[xml.ButtonSoundInfo3[0]["@class"].toString()]||SOUNDINFO)();
