...
创建时间：2011年08月29日 15:15:54（代码生成器 V2.0.0 F:/airs/program files2/CodesGenerater2/bin-debug/CodesGenerater2.swf）
简要说明：这家伙很懒什么都没写。
用法举例：这家伙还是很懒什么都没写。
*/
...
package zero.swf.tagBodys{
	...
	public class DefineFont2{
		...
		public function toData(_toDataOptions:Object):ByteArray{
			...
			var FontFlagsWideOffsets:Boolean;
			...
			var DOffset:int,Offset:int,OffsetsLen:int;
			if(FontFlagsWideOffsets){
