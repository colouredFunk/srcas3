...
创建时间:2010年10月8日 18:52:31 (代码生成器: F:/airs/program files2/CodesGenerater/bin-debug/CodesGenerater.swf) 
历次修改:未有修改
用法举例:这家伙很懒什么都没写
*/
...
package zero.swf.record{
	...
	public class GRADIENT extends Record{
		...
		override public function toData():ByteArray{
			...
			var count:int=GradientRecordV.length;
			//#offsetpp
			data.position=1;
