...
package zero.swf.avm1{
	...
	public class ACTIONRECORDs{//implements I_zero_swf_CheckCodesRight{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			var skipId:int,skipOp:int,skipLength:int;
			...
			while(offset<endOffset){
				...
				if(op<0x80){
					...
					switch(op){
						...
						break;
						case AVM1Ops.storeRegister://0x87
						...
						break;
						case AVM1Ops.waitForFrame://0x8a
						...
						case AVM1Ops.gotoLabel://0x8c
							...
							offset+=get_str_size;
						break;
						case AVM1Ops.waitForFrame2://0x8d
							skipId=data[offset++];
							jumpPos=offset;
							while(--skipId>=0){
								skipOp=data[jumpPos++];
						...
						case AVM1Ops.defineFunction://0x9b
							...
							code.value.endMark=labelMark;
						break;
						case AVM1Ops.jump://0x99
						case AVM1Ops.if_://0x9d
		...
		public function toData(_toDataOptions:Object/*zero_swf_ToDataOptions*/):ByteArray{
			...
			if(constCode){
				...
				constCode=new AVM1Code(AVM1Ops.constantPool,[]);
