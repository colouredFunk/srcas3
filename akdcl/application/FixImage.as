package akdcl.application {
	...
	public class FixImage extends UISprite {
		...
		//
		protected var __cutedBMD:BitmapData;

		public function get cutedBMD():BitmapData {
			return __cutedBMD;
		}
		...
		protected function updateBMD():void {
			...
			__cutedBMD = getContainBmd(moveRect, imageLoader);
			bitmapView.bitmapData = __cutedBMD;
