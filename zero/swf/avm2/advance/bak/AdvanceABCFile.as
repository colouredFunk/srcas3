...
创建时间:2010年10月24日 12:33:57 (代码生成器: F:/airs/program files2/CodesGenerater/bin-debug/CodesGenerater.swf) 
历次修改:未有修改
用法举例:这家伙很懒什么都没写
*/
...
package zero.swf.avm2.advance{
	...
	public class AdvanceABCFile extends Advance{
		...
		public function initByInfo(info:ABCFile):void{
			...
			var count:int=info.ns_set_infoV.length;
		...
		public function toInfo():ABCFile{
			...
			var count:int=ns_set_infoV.length;
