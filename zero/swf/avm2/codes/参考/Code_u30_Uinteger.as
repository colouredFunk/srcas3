/***
Code_u30_Uinteger 版本:v1.0
简要说明:这家伙很懒什么都没写
创建人:ZЁЯ¤  身高:168cm+;体重:57kg+;未婚(已有女友);最爱的运动:睡觉;格言:路见不平,拔腿就跑;QQ:358315553
创建时间:2010年7月13日 08:05:46
历次修改:未有修改
用法举例:这家伙很懒什么都没写
*/
...
package zero.swf.avm2.codes{
	...
	import flash.events.*;
	import flash.utils.*;
	public class Code_u30_Uinteger extends Code_u30 implements ICodeObj,IClassObj{
		public var uinteger:uint;
		//
		public function Code_u30_Uinteger(){
		}
		//
		public function toXML(xmlName:String):XML{
			var xml:XML=new XML("<"+Op.op_v[op]+"/>");
			xml.uinteger=uinteger;
			return xml;
		}
		override public function toString():String{
			return Op.op_v[op]+" "+uinteger;
		}
		override public function getData(data:ByteArray):void{
			u30=getUintId(uinteger);
			super.getData(data);
		}
		public function putObjsInLists():void{
			putUintInList(uinteger);
		}
