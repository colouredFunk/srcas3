...
package zero.swf.avm2{
	...
	public class AVM2Tests extends BaseTests{
		...
		private function testABCNamespaces():void{
			...
			check(xml.toXMLString(),<ns class="ABCNamespace" kind="PackageNamespace" name="\\"/>.toXMLString());
			...
			xml=ns.toXMLAndMark(new MarkStrs(),"ns",null);
			check(xml.toXMLString(),<ns class="ABCNamespace" kind="PrivateNs" name="[&#xA;](1)"/>.toXMLString());
			...
			ns=ABCNamespace.markStr2ns(markStrs,"(name=undefined)(2)");
			xml=ns.toXMLAndMark(markStrs,"ns",null);
			check(xml.toXMLString(),<ns class="ABCNamespace" kind="PackageNamespace" copyId="2"/>.toXMLString());
			check(ABCNamespace.xml2markStr(xml),"(name=undefined)(2)");
			...
			ns=ABCNamespace.markStr2ns(markStrs,"(name=undefined)");
			xml=ns.toXMLAndMark(markStrs,"ns",null);
			check(xml.toXMLString(),<ns class="ABCNamespace" kind="PackageNamespace"/>.toXMLString());
			check(ABCNamespace.xml2markStr(xml),"(name=undefined)");
			...
			ns=ABCNamespace.markStr2ns(markStrs,"[PrivateNs]flash.display(2)");
			xml=ns.toXMLAndMark(markStrs,"ns",null);
			check(xml.toXMLString(),<ns class="ABCNamespace" kind="PrivateNs" name="flash.display" copyId="2"/>.toXMLString());
			check(ABCNamespace.xml2markStr(xml),"[PrivateNs]flash.display(2)");
		}
		...
		private function testABCNs_sets():void{
			...
			check(
				xml.toXMLString(),
				<ns_set class="ABCNs_set">
				  <nsList count="3">
				    <ns class="ABCNamespace" kind="PrivateNs"/>
				    <ns class="ABCNamespace" kind="PrivateNs"/>
				    <ns class="ABCNamespace" kind="PrivateNs"/>
				  </nsList>
				</ns_set>.toXMLString()
			...
			xml=<ns_set class="ABCNs_set">
				<nsList count="3">
				  ...
				  <ns class="ABCNamespace" kind="PrivateNs" name="哈哈"/>
				</nsList>
			  </ns_set>
			...
			check(
				...
				<ns_set class="ABCNs_set">
				  <nsList count="6">
					<ns class="ABCNamespace" kind="PackageNamespace" name=""/>
					<ns class="ABCNamespace" kind="PackageNamespace" name="*"/>
					<ns class="ABCNamespace" kind="PackageNamespace" name="undefined"/>
					<ns class="ABCNamespace" kind="PackageNamespace" name="null"/>
					<ns class="ABCNamespace" kind="PackageNamespace" name="flash.display"/>
					<ns class="ABCNamespace" kind="PrivateNs" name="哈哈"/>
				  </nsList>
				</ns_set>.toXMLString()
			);
			...
			check(
				...
				<ns_set class="ABCNs_set">
				  <nsList count="2">
				    <ns class="ABCNamespace" kind="PackageNamespace" name=","/>
				    <ns class="ABCNamespace" kind="PackageNamespace" name="," copyId="2"/>
				  </nsList>
				</ns_set>.toXMLString()
			);
		}
		private function testABCMultinames():void{
			...
			check(
				xml.toXMLString(),
				<multiname class="ABCMultiname" kind="QName" name="MovieClip">
  					<ns class="ABCNamespace" kind="PackageNamespace" name="flash.display"/>
			...
			check(
				xml.toXMLString(),
				<multiname class="ABCMultiname" kind="QName">
				  <ns class="ABCNamespace" kind="PackageNamespace" name=""/>
				</multiname>.toXMLString()
			);
			check(ABCMultiname.xml2markStr(xml),"(name=undefined)");
			...
			check(
				xml.toXMLString(),
				<multiname class="ABCMultiname" kind="QName" name=""/>.toXMLString()
			);
			check(ABCMultiname.xml2markStr(xml),"(ns=undefined)");
			...
			check(
				xml.toXMLString(),
				<multiname class="ABCMultiname" kind="QName"/>.toXMLString()
			);
			check(ABCMultiname.xml2markStr(xml),"(ns=undefined)(name=undefined)");
			...
			check(
				xml.toXMLString(),
				<multiname class="ABCMultiname" kind="QNameA" name="*" copyId="2">
					<ns class="ABCNamespace" kind="PackageNamespace" name=""/>
				</multiname>
				.toXMLString()
			);
			...
			check(
				xml.toXMLString(),
				<multiname class="ABCMultiname" kind="Multiname" name="*" copyId="2">
				  <ns_set class="ABCNs_set" copyId="2">
					<nsList count="3">
					  <ns class="ABCNamespace" kind="PackageNamespace" name="flash.display"/>
					  <ns class="ABCNamespace" kind="PackageNamespace" name="flash.events"/>
					  <ns class="ABCNamespace" kind="PackageNamespace" name="flash.utils"/>
					</nsList>
				  </ns_set>
				</multiname>
				.toXMLString()
			...
			check(
				xml.toXMLString(),
				<multiname class="ABCMultiname" kind="GenericName">
				  <TypeDefinition class="ABCMultiname" kind="QName" name="Vector">
					<ns class="ABCNamespace" kind="PackageNamespace" name=""/>
				  </TypeDefinition>
				  <ParamList count="1">
					<Param class="ABCMultiname" kind="QName" name="String">
					  <ns class="ABCNamespace" kind="PackageNamespace" name=""/>
					</Param>
				  </ParamList>
				</multiname>
			...
			check(
				...
				<multiname class="ABCMultiname" kind="RTQName" name="&#xA;"/>.toXMLString()
			);
		}
		private function testABCMethods():void{
			...
			check(
				xml.toXMLString(),
				<method class="ABCMethod" name="哈哈">
				  <return_type class="ABCMultiname" kind="QName" name="MovieClip">
					<ns class="ABCNamespace" kind="PackageNamespace" name="flash.display"/>
				  </return_type>
				  <param_typeList count="3">
					<param_type/>
					<param_type class="ABCMultiname" kind="QName" name="MovieClip">
					  <ns class="ABCNamespace" kind="PackageNamespace" name="flash.display"/>
					</param_type>
					<param_type/>
				  </param_typeList>
			...
			method=ABCMethod.xml2method(
				markStrs,
				<method class="ABCMethod" name="哈哈" return_type="flash.display.MovieClip">
				  <param_typeList count="3">
				    <param_type markStr="*"/>
				    <param_type class="ABCMultiname" kind="QName" name="MovieClip">
				      <ns class="ABCNamespace" kind="PackageNamespace" name="flash.display"/>
