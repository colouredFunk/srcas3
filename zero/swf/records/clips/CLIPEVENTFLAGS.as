...
package zero.swf.records.clips{
	...
	public class CLIPEVENTFLAGS{//implements I_zero_swf_CheckCodesRight{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			ClipEventKeyUp=Boolean(flags&0x80);				//10000000
			ClipEventKeyDown=Boolean(flags&0x40);			//01000000
			ClipEventMouseUp=Boolean(flags&0x20);			//00100000
			ClipEventMouseDown=Boolean(flags&0x10);			//00010000
			ClipEventMouseMove=Boolean(flags&0x08);			//00001000
			ClipEventUnload=Boolean(flags&0x04);			//00000100
			ClipEventEnterFrame=Boolean(flags&0x02);		//00000010
			ClipEventLoad=Boolean(flags&0x01);				//00000001
			
			flags=data[offset+1];
			ClipEventDragOver=Boolean(flags&0x80);			//10000000
			ClipEventRollOut=Boolean(flags&0x40);			//01000000
			ClipEventRollOver=Boolean(flags&0x20);			//00100000
			ClipEventReleaseOutside=Boolean(flags&0x10);	//00010000
			ClipEventRelease=Boolean(flags&0x08);			//00001000
			ClipEventPress=Boolean(flags&0x04);				//00000100
			ClipEventInitialize=Boolean(flags&0x02);		//00000010
			ClipEventData=Boolean(flags&0x01);				//00000001
			...
			ClipEventConstruct=Boolean(flags&0x04);			//00000100
			ClipEventKeyPress=Boolean(flags&0x02);			//00000010
			ClipEventDragOut=Boolean(flags&0x01);			//00000001
