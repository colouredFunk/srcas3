...
package zero.swf.records{
	...
	public class Filter{//implements I_zero_swf_CheckCodesRight{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			switch(FilterID){
				case FilterIDs.DROPSHADOWFILTER:
					...
					flags=data[offset+23];
					InnerShadow=Boolean(flags&0x80);				//10000000
					Knockout=Boolean(flags&0x40);					//01000000
					CompositeSource=Boolean(flags&0x20);			//00100000
				...
				case FilterIDs.GLOWFILTER:
					...
					InnerGlow=Boolean(flags&0x80);					//10000000
					Knockout=Boolean(flags&0x40);					//01000000
					CompositeSource=Boolean(flags&0x20);			//00100000
					Passes=flags&0x1f;								//00011111
					return offset+16;
				...
				case FilterIDs.BEVELFILTER:
					...
					Knockout=Boolean(flags&0x40);					//01000000
					CompositeSource=Boolean(flags&0x20);			//00100000
					OnTop=Boolean(flags&0x10);						//00010000
				...
				case FilterIDs.CONVOLUTIONFILTER:
					...
					Clamp=Boolean(flags&0x02);							//00000010
					PreserveAlpha=Boolean(flags&0x01);					//00000001
					return offset;
				break;
