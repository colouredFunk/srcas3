...
package zero.swf.records{
	...
	public class CXFORM{//implements I_zero_swf_CheckCodesRight{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			HasAddTerms=Boolean(bGroupValue&0x80000000);					//10000000 00000000 00000000 00000000
			
			HasMultTerms=Boolean(bGroupValue&0x40000000);				//01000000 00000000 00000000 00000000
		...
		public function toXML(xmlName:String,_toXMLOptions:Object/*zero_swf_ToXMLOptions*/):XML{
			var xml:XML=<{xmlName} class="zero.swf.records.CXFORM"/>;
			if(HasAddTerms){
