...
创建时间：2011年08月27日 10:49:42（代码生成器 V2.0.0 F:/airs/program files2/CodesGenerater2/bin-debug/CodesGenerater2.swf）
简要说明：这家伙很懒什么都没写。
用法举例：这家伙还是很懒什么都没写。
*/
...
package zero.swf.tagBodys{
	...
	public class DefineBitsJPEG3{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object):int{
			...
			offset=ImageData.initByData(data,offset,offset+AlphaDataOffset,_initByDataOptions);
		...
		CONFIG::USE_XML{
			public function toXML(xmlName:String,_toXMLOptions:Object):XML{
				...
				var xml:XML=<{xmlName} class="zero.swf.tagBodys.DefineBitsJPEG3"
					id={id}
				/>;
