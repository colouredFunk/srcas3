/***
DefineEditText 版本:v1.0
简要说明:这家伙很懒什么都没写
创建人:ZЁЯ¤  身高:168cm+;体重:57kg+;未婚(已有女友);最爱的运动:睡觉;格言:路见不平,拔腿就跑;QQ:358315553
创建时间:2010年12月12日 18:53:46 (代码生成器: F:/airs/program files2/CodesGenerater/bin-debug/CodesGenerater.swf) 
历次修改:未有修改
用法举例:这家伙很懒什么都没写
*/
...
package zero.swf.tagBodys{
	...
	public class DefineEditText{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int):int{
			...
			offset+=2;
			Bounds=new RECT();
			offset=Bounds.initByData(data,offset,endOffset);
		...
		public function toXML(xmlName:String):XML{
			...
			/>;
			xml.appendChild(Bounds.toXML("Bounds"));
			if(HasFont){
