...
创建时间：2011年08月24日 16:12:42（代码生成器 V2.0.0 F:/airs/program files2/CodesGenerater2/bin-debug/CodesGenerater2.swf）
简要说明：这家伙很懒什么都没写。
用法举例：这家伙还是很懒什么都没写。
*/
...
package zero.swf.tagBodys{
	...
	public class LANGCODEs{
		...
		public static const codeV:Vector.<String>=Vector.<String>([
			null,//0x00
			"Latin",//0x01
			"Japanese",//0x02
			"Korean",//0x03
