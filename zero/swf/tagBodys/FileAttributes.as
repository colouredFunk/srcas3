...
package zero.swf.tagBodys{
	...
	public class FileAttributes{//implements I_zero_swf_CheckCodesRight{
		...
		public function initByData(data:ByteArray,offset:int,endOffset:int,_initByDataOptions:Object/*zero_swf_InitByDataOptions*/):int{
			...
			UseDirectBlit=Boolean(flags&0x40);			//01000000
			UseGPU=Boolean(flags&0x20);					//00100000
			HasMetadata=Boolean(flags&0x10);			//00010000
			ActionScript3=Boolean(flags&0x08);			//00001000
			//Reserved=flags&0x06;						//00000110
			UseNetwork=Boolean(flags&0x01);				//00000001
