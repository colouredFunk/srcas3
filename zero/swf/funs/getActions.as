...
package zero.swf.funs{
	...
	public function getActions(swf:SWF,_initByDataOptions:Object=null):*{
		...
		var ActionsV:*;
		switch(_initByDataOptions.ActionsClass){//20120626
			case BytesData:
				ActionsV=new Vector.<BytesData>();
			break;
			default:
				ActionsV=new Vector.<ACTIONRECORDs>();
			break;
		}
		var ClipActions:CLIPACTIONs;
		var ClipActionRecord:CLIPACTIONRECORD;
			...
			for each(var tag:Tag in tagV){
				switch(tag.type){
					...
					case TagTypes.PlaceObject2:
						ClipActions=tag.getBody(PlaceObject2,_initByDataOptions).ClipActions;
						if(ClipActions){
