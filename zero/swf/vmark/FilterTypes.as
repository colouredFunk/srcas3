...
package zero.swf.vmark{
	...
	public class FilterTypes extends VMark{
		...
		private static function get_classV():Vector.<Class>{
			...
			classV.fixed=true;
			classV[0]=zero.swf.record.filters.DROPSHADOWFILTER;
			classV[1]=zero.swf.record.filters.BLURFILTER;
			classV[2]=zero.swf.record.filters.GLOWFILTER;
			classV[3]=zero.swf.record.filters.BEVELFILTER;
			classV[4]=zero.swf.record.filters.GRADIENTGLOWFILTER;
			classV[5]=zero.swf.record.filters.CONVOLUTIONFILTER;
			classV[6]=zero.swf.record.filters.COLORMATRIXFILTER;
			classV[7]=zero.swf.record.filters.GRADIENTBEVELFILTER;
			return classV;
		}
		////
		//
